...
// Stats
var $statH3 = $("#stats .vehicle h3");
var $statSpan = $("#stats h2 span");

// Services 
var $leftBefore = $(".left-graphic");
var $rightBefore = $(".right-graphic");
var $serviceH3 = $(".service-item h3");
...
const enableDarkMode = () => {
  ...
  // Stats
  $statH3.addClass("dark-mode");
  $statSpan.addClass("dark-mode");

  // Services
  $leftBefore.addClass("dark-mode");
  $rightBefore.addClass("dark-mode");
  $serviceH3.addClass("dark-mode");
...
const disableDarkMode = () => {
  ...
  // Stats
  $statSpan.remove("dark-mode");
  $statH3.remove("dark-mode");

  // Services
  $leftBefore.removeClass("dark-mode");
  $rightBefore.removeClass("dark-mode");
  $serviceH3.removeClass("dark-mode");
